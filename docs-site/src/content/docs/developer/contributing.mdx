...
<Steps>
  ...
  2. Clone your fork and set up the dev environment (see [Project Setup](../developer/project-setup/))
...
See [Architecture](../developer/architecture/) and [Core Systems](../developer/core-systems/) for deeper context.
